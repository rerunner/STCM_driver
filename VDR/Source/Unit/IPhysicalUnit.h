...
class IPhysicalUnit : virtual public IVDRPhysicalUnit,
	...
	public:
		...
		*/
		virtual STFResult Create(uint64 * createParams) = 0;
		...
		*/
		virtual STFResult Connect(uint64 localID, IPhysicalUnit * source) = 0;
		...
		*/
		virtual STFResult Initialize(uint64 * depUnitsParams) = 0;
